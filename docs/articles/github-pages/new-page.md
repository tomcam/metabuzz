...
![Create a file named tutorial.md in the /docs directory](/assets/img/github-create-tutorial-md-file.png)
...
![tutorial.md file next to README.md in GitHub](/assets/img/tutorial-and-readme.png)
...
![README.md preview](/assets/img/github-pages-nav-tutorial.png)
...
![Link added to README.md](/assets/img/github-pages-link-added.png)

* Click the link and you'll navigate to GitHub's preview of the tutorial page:

![Tutorial page preview](/assets/img/github-pages-tutorial-md.png)

Next: [Publish your site on GitHub Pages](enable-github-pages.md) 
